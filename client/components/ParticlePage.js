...
export default class ParticlePage extends React.Component {
  render() {
    ...
    if (this.props.winner) {
      ...
      let winnerPath =
        "https://www.cryptocompare.com" + this.props.winner.ImageUrl;
      let loserPath =
        "https://www.cryptocompare.com" + this.props.loser.ImageUrl;
      ...
      let totalCap = numeral(this.props.globalData.total_market_cap_usd).format(
        "$0,0"
      );
      let dailyVolume = numeral(
            ...
            params={{
              particles: {
                ...
                shape: {
                  ...
                  image: {
                    src:
                      "http://pngriver.com/wp-content/uploads/2017/12/download-Bitcoin-symbol-PNG-transparent-images-transparent-backgrounds-PNGRIVER-COM-bitcoin-225078_960_720.png?x61933",
                    width: 100,
                    height: 100
                  }
                },
          ...
          <div className="gainer-loser-container">
            <div className="gainer">
              ...
              <div className="line">
                ...
                <h3 className="green">
                  {this.props.winner.percent_change_24h}%
                  <FontAwesome className="green" name="arrow-up" size="lg" />
                </h3>
              </div>
              ...
              <Link
                ...
                to={"/coins/" + this.props.winner.symbol}
              >
                View Coin
              </Link>
            </div>
            <div className="loser">
              ...
              <div className="line">
                ...
                <h3 className="red">
                  {this.props.loser.percent_change_24h}%
                  <FontAwesome className="red" name="arrow-down" size="lg" />
                </h3>
              </div>
              ...
              <Link
                className="coinButton"
                to={"/coins/" + this.props.loser.symbol}
              >
                View Coin
              </Link>
            </div>
