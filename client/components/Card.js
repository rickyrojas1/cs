        ...
        <div className="card1 ">
          ...
          <div className="card-block1">
            <p>
              ...
              {this.props.info.Algorithm ? this.props.info.Algorithm : "N/A"}
            </p>
            <p>
              <strong>
                Proof Type:
              ...
              {this.props.info.ProofType ? this.props.info.ProofType : "N/A"}
            </p>
            <p>
              <strong>
                Block Number:
            ...
            <p>
              ...
              {this.props.info.StartDate ? this.props.info.StartDate : "N/A"}
            </p>
            <p>
              <strong>
                Total Coins Mined:
