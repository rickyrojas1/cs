...
class Add extends React.Component {
  ...
  insertNewExpense(e) {
    ...
    axios.post('/tickers', querystring.stringify({pairing: e.state.description}), {
      headers: {
        "Content-Type": "application/x-www-form-urlencoded"
      }
    }).then(function(response) {
      ...
      return (<div>
        ...
        <Modal isOpen={this.state.modalIsOpen} onRequestClose={this.closeModal} contentLabel="Add Expense" className="Modal">
          ...
          <div className='button-center'>
            ...
            <br/>
            <Button bsStyle="success" onClick={this.onClick}>Add New Expense</Button>
          </div>
        </Modal>
        ...
        <Modal isOpen={this.state.modalIsOpen} onAfterOpen={this.afterOpenModal} onRequestClose={this.closeModal} contentLabel="Add Expense" className="Modal">
          <div className='button-center'>
            ...
            <Link to={{
              ...
              <Button bsStyle="success" onClick={this.closeModal}>Close the Dialog</Button>
            </Link>
          </div>
        </Modal>
      </div>)
