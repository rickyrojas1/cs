...
class CoinCard extends Component {
  ...
  render() {
    ...
    if (this.props.info.FullName) {
      ...
      var dailyVolume = numeral(this.props.coin["24h_volume_usd"]).format('$0,0');
      ...
      return (<div className="coincard1">
          ...
          <div className="left-flex">
            ...
            <div className="coinName1">
              ...
              <div className="middleLine1">
                <h3 >{price}</h3>
                <h3 className={dailycolor}>&nbsp; ({this.props.coin.percent_change_24h}%)</h3>
              </div>

              <h5>
                <FontAwesome className='super-crazy-colors' name='btc' size='md' />{this.props.coin.price_btc}</h5>
