...
import RedditWrapper from './reddit-wrapper';
...
class SocialDash extends React.Component {
  ...
  componentDidMount() {
    console.log("link");
    console.log(this.props.info.data.Data.Twitter.link);
      ...
      return (<div className="social-container">
        <div className="social-grid">
          <div className="title sm">
            ...
            <h1>Social Media</h1>
            <a href={this.props.websiteUrl} className="site-link" target="_blank">Website</a>
            <div className="icons">
              {console.log(this.state.reddit)}
              {

                this.state.github[0]
                  ? <a target="_blank" href={this.state.github[0].url}><img src="../img/git.png" className="icon"/></a>
                  : ""
              }
              {

                this.state.facebook != "none"
                  ? <a target="_blank" href={this.state.facebook}><img src="../img/fb.png" className="icon"/></a>
                  : ""
              }
              {

                this.state.reddit != "none"
                  ? <a target="_blank" href={this.state.reddit}><img src="../img/reddit.png" className="icon"/></a>
                  : ""
              }
              {

                this.state.twitter != "none"
                  ? <a target="_blank" href={this.state.twitter}><img src="../img/twitter.png" className="icon"/></a>
                  : ""
              }
